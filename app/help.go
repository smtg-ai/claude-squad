...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("e")+descStyle.Render("         - Open the session's worktree in $EDITOR (config: editor_command)"),
...
func (h helpTypeInstanceStart) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("e")+descStyle.Render("     - Open the session's worktree in an editor"),
