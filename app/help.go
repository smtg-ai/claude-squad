...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("f")+descStyle.Render("         - Focus: type into the session from the preview (ctrl-q/ctrl-f to leave)"),
		keyStyle.Render("ctrl-q")+descStyle.Render("    - Detach from session / leave focus"),
		"",
