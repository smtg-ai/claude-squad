...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("tab")+descStyle.Render("       - Switch between preview, diff, and editor tabs"),
		keyStyle.Render("e")+descStyle.Render("         - Open editor (nvim) in instance worktree"),
