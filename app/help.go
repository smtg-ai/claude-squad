...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("/")+descStyle.Render("         - Focus search input"),
		keyStyle.Render("esc")+descStyle.Render("       - Exit search (keep filter)"),
		keyStyle.Render("ctrl-c")+descStyle.Render("    - Clear search and filter"),
		keyStyle.Render("↑/↓")+descStyle.Render("       - Navigate filtered sessions"),
		"",
