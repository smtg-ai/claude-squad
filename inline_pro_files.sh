...
# Find all *_pro.go files under the pro directory and copy to the corresponding non-pro directory. Remember
# to add !pro and pro build flags to the basic and pro .go files respectively
find "$PRO_DIR" -type f -name '*_pro.go' | while read -r pro_file; do
